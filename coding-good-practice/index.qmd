...
::: {layout-ncol="2"}
![R Studio interface](../images/coding-images/coding_screenshot.png){group="coding-group"}

![GitHub interface](../images/coding-images/github_screenshot.png){group="coding-group"}
:::
...
## Why is good code hygiene important?
