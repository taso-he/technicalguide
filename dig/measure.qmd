...
::: {style="text-align: left; margin-top: 10px;"}
<a href="https://cdn.taso.org.uk/wp-content/uploads/2022_11_BIT_University_of_Leicester_analysis_report_Curriculum-reform-EDAG_TASO.pdf"> <button type="button" style="
      background-color: #3b66bc; 
      color: white; 
      font-weight: bold;
      padding: 10px 20px; 
...
::: {style="text-align: left; margin-top: 10px;"}
<a href="https://cdn.taso.org.uk/wp-content/uploads/2022-11_BIT_University_of_Kent_analysis_report_Curriculum-reform_EDAG_TASO.pdf"> <button type="button" style="
      background-color: #3b66bc; 
      color: white; 
      font-weight: bold;
      padding: 10px 20px; 
