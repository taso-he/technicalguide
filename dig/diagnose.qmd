...
::: callout-note
Here, we use the [Open University Learning Analytics Dataset (OULAD)](https://analyse.kmi.open.ac.uk/open_dataset). This analysis is educational and illustrative, to show the potential applications of various statistical techniques, using a dataset with variables familiar to many institutions.

The R code to create figures and tables below is available on our [GitHub page](https://github.com/taso-he/technicalguide).
:::
...
#| fig-alt: "Box plots showing that both overall and across modules, students from deprived areas score lower on average"
#| fig-subcap:
#|   - "Average scores are lower for students from deprived areas"
#|   - "Across modules, students from deprived areas score lower on average" 
...
#| #| fig-alt: "Line charts showing that both overall and across modules, there are gaps in scores between students from deprived areas and non-deprived areas"
#| fig-subcap:
#|   - "Over time, there are persistent gaps in average module scores between students from deprived and non-deprived areas"
#|   - "Between courses, there is variation in the size of the gap in average module scores between students from deprived and non-deprived areas" 
...
To report the results of this t-test in text you would write: There was a significant difference between the scores for students from deprived areas and the scores for students not from deprived areas (t(10686.68) = 15.88, p\<0.001).
...
While this simple regression is comparable to our t-test in that it assesses the difference between two groups, it also allows us to quantify the exact impact of deprivation status on scores. Unlike the t-test, which only tells us if there is a significant difference, regression provides an estimate of how much lower students from deprived areas score on average. Here, the regression results in @tbl-simple_regression_results tell us that students from deprived areas score, on average, 7 marks lower (see highlighted row).
...
#| fig-cap: Students from deprived areas score, on average, 7 marks lower
#| fig-alt: "Dot plot with error bars showing that students from deprived areas score, on average, 7 marks lower, and that this difference is statistically significant"
...
>>>>>>> 32b7bf989ef75e81994a35ffef1c704cd94142dd

::::: columns
::: {.column width="50%"}
- [Theory of Change Builder](https://taso.org.uk/libraryitem/theory-of-change-builder/)

- [Core Theory of Change templates](https://taso.org.uk/libraryitem/core-theory-of-change/#core-theory-of-change-template)

<<<<<<< HEAD
- [Theory of Change workshop resources](https://taso.org.uk/libraryitem/theory-of-change-workshop-resources/)
=======
...
- [Enhanced Theory of Change templates](https://taso.org.uk/libraryitem/enhanced-theory-of-change/#tasos-enhanced-toc-narrative-template)
:::

::: {.column width="50%"}
<<<<<<< HEAD
- [Theories of Change for the ethnicity degree awarding gap (EDAG)](https://taso.org.uk/libraryitem/project-theory-of-change-to-tackle-ethnicity-degree-awarding-gaps/)

- [Theories of Change for attainment-raising initiatives](https://taso.org.uk/libraryitem/project-theories-of-change-for-attainment-raising-initiatives/)
=======
