...
![Flowchart for choosing between experimental and quasi-experimental methods](/images/dig-images/flowchart_diagram.jpg){#fig-flowchart fig-alt="Flowchart for selecting research and evaluation methods. The chart guides users through a series of questions about their research approach, data availability, and intervention design. It covers topics such as theory of change, experimental methods, randomised controlled trials (RCTs), and quasi-experimental designs (QEDs). The chart helps researchers determine the most appropriate evaluation method based on their specific circumstances and constraints."}
