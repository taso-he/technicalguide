...
::: columns
::: {.column width="50%"}
![Difference-in-difference diagram](..\images/dig-images/diff-in-diff.png){#fig-diff-in-diff fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Regression discontinuity design diagram](..\images/dig-images/rdd.png){#fig-rdd fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Instrumental variables diagram](..\images/dig-images/iv.png){#fig-iv fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Matching methods diagram](..\images/dig-images/matching_methods.png){#fig-matching fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Interrupted time-series diagram](..\images/dig-images/interrupted_time_series.png){#fig-interrupted-time-series fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Synthetic control diagram](..\images/dig-images/synthetic-control.png){#fig-synthetic-control fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Individual RCT diagram](..\images/dig-images/individual_rct.png){#fig-individual-rct fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Cluster RCT diagram](..\images/dig-images/cluster_rct.png){#fig-cluster fig-align="center"}
:::
...
::: columns
::: {.column width="50%"}
![Waitlist RCT diagram](..\images/dig-images/waitlist_rct.png){#fig-waitlist fig-align="center"}
:::
