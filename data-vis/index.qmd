...
![](../images/data-vis-images/ed_path_fig_2){group="my-group"}
...
```{r fig.align="center", fig.alt = "Bar chart with TASO stylings - putty background, Arial font, minimal gridlines. Title is largest text on the page in bold with subtitle underneath. Caption is in italics.",}
